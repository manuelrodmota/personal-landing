...
export const es: Content = {
  ...
  projects: [
    ...
    },
    {
      ...
      tag: "Juego",
      title: "Mundialito",
      role: "Proyecto personal · noches y fines de semana",
      desc: "Un juego arcade de cartas donde armás un mazo con tus jugadores legendarios favoritos, hacés una campaña por la Copa del Mundo enfrentando a los mejores equipos de la historia y desafiás a tus amigos en multijugador en tiempo real.",
      points: [
        "Una web app que renderiza todo el juego — abrís sobres para armar tu mejor mazo y buscás ganarlo todo en una campaña arcade",
        "Multijugador en tiempo real para jugar online contra tus amigos",
        "Un montón de animaciones y mecánicas que la hacen entretenida y divertida",
      ],
      tags: ["Vue", "Web-based", "Animation", "HTML"],
      link: "https://mundialitoonline.com/",
      linkLabel: "mundialitoonline.com",
      shot: "Mundialito — captura del juego",
